...
#test_loss, sdr,
    def log_evaluation(self,
        ...
        # self.add_scalar('single data/test_loss', test_loss, step)
        # self.add_scalar('single data/SDR', sdr, step)
    ...
    def log_validation_metrics(self, avg_loss, avg_sdr, lr, step):
        self.add_scalar('test_loss', avg_loss, step)
        self.add_scalar('SDR', avg_sdr, step)
